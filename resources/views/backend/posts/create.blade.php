...
@section('content')
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
            ...
            <!--Keywords-->
            <div class="form-group mb-3">
                <label for="keywords">Keywords (gescheiden door komma's):</label>
                <input type="text" name="keywords" id="keywords" class="border rounded w-full p-2" placeholder="Keyword 1, Keyword 2...">
            </div>
